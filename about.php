...
<body>
   ...
   <section class="reviews">
      ...
      <div class="box-container">
         ...
         ?>
            <div class="box">
               <?php if($reviws['username'] == 'Irteja'): ?>
                  <img src="asfiqul.jpeg" alt="">
               <?php else: ?>
                  <img src="uploaded_img/<?php echo $reviws['userpic']; ?>" alt="">
               <?php endif; ?>
...
<img src="images/asfiqul.jpeg" alt="">

<!-- OR if the image is in the uploaded_img folder -->
<img src="uploaded_img/asfiqul.jpeg" alt="">
